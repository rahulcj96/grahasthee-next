...
export default function CartDrawer() {
    const { cart, removeFromCart, updateCartQuantity, clearCart, isCartOpen, setIsCartOpen } = useStore();
        ...
        <>
            ...
            >
                <div className="offcanvas-header border-bottom">
                    <h5 className="offcanvas-title text-uppercase fw-bold">Your Cart ({cart.length})</h5>
                    <button
                        type="button"
                ...
                {cart.length > 0 && (
                    <div className="cart-footer p-3 border-top bg-white">
                        ...
                        <button
                            className="btn btn-link w-100 text-muted small text-decoration-none shadow-none"
                            onClick={clearCart}
                        >Clear Cart</button>
                    </div>
                )}
