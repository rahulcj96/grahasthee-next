    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" style={{ display: "none" }}>
            <defs>
                ...
                <symbol xmlns="http://www.w3.org/2000/svg" id="whatsapp" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91c0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21c5.46 0 9.91-4.45 9.91-9.91c0-2.65-1.03-5.14-2.9-7.01A9.816 9.816 0 0 0 12.04 2m.01 1.67c2.2 0 4.26.86 5.82 2.42a8.225 8.225 0 0 1 2.41 5.83c0 4.54-3.7 8.23-8.24 8.23c-1.48 0-2.93-.39-4.19-1.15l-.3-.17l-3.12.82l.83-3.04l-.2-.32a8.188 8.188 0 0 1-1.26-4.38c0-4.54 3.7-8.24 8.25-8.24m-3.4 4.93c-.19 0-.39.03-.58.18c-.18.15-.61.59-.61 1.46c0 .88.63 1.72.71 1.84c.09.11 1.24 1.9 3.01 2.66c.42.18.75.29 1.01.37c.42.13.81.11 1.11.07c.33-.05 1.01-.41 1.15-.81c.14-.39.14-.73.1-.81c-.04-.08-.15-.12-.33-.21c-.17-.09-1.01-.5-1.17-.56c-.16-.05-.27-.08-.39.08c-.11.16-.45.56-.55.67c-.1.11-.2.12-.37.03c-.18-.09-.75-.28-1.43-.88c-.53-.47-.88-1.06-1-1.25c-.11-.19-.01-.29.08-.38c.08-.08.18-.21.27-.32c.09-.1.12-.17.18-.29c.06-.12.03-.23-.01-.32c-.04-.09-.39-.93-.54-1.29c-.14-.35-.29-.31-.39-.31" />
                </symbol>
            </defs>
        </svg>
    );
